...
```{python}
# Load the data
emissions = pd.read_csv("C:/Users/cansu/Desktop/GRAPH/data/co2_cons.csv")
```
...
selected_countries = ["Angola", "Albania", "Andorra", "Australia", "Austria"]
